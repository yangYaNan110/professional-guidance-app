...
推荐规则根据用户是否设置省份、分数、专业，分为以下场景：

| 场景 | 条件 | 推荐逻辑 | 推荐结果 |
|-----|------|---------|---------|
| **场景1** | 省份+分数+专业 | 1. 优先推荐该省符合分数和专业的大学<br>2. 不足5所时补充全国符合分数和专业的大学 | 分数匹配大学 |
| **场景2** | 只有省份 | 1. 优先推荐同省该专业大学<br>2. 不足5所时补充全国该专业大学 | 同省优质大学 + 全国推荐大学 |
| **场景3** | 只有分数 | 按分数匹配（±30分范围）推荐 | 分数匹配大学 |
| **场景4** | 都没有设置 | 按专业匹配度和就业率排序推荐 | 全国推荐大学 |
| **场景5** | 省份+分数（无专业） | 1. 优先推荐该省符合分数的大学<br>2. 不足5所时补充全国符合分数的大学 | 分数匹配大学 |
| **场景6** | 只有省份（无专业） | 按就业率排序推荐本省高校 | 同省优质大学 |
| **兜底** | 无法匹配 | 返回就业率最高的大学 | 全国知名大学 |
